...
- (void) sendEmail:(NSString*)mailbody
{
    if (![MFMailComposeViewController canSendMail]) {
        ...
        UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"" message:EMAIN_TEXT_ERROR delegate:nil cancelButtonTitle:@"OK" otherButtonTitles:nil, nil];
        [alert show];
        return;
    }
...
-(void) sendEmailWithScreen:(NSString*) filepath
{
    ...
    NSString* mailbody = @"Hi,\n\n I’ve been playing Alef Bet Bullseye and here is my score.";
