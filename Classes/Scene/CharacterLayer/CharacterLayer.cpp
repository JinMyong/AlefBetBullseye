...
#define POS_STAR        ccp(400 * SCALEX, 430 * SCALEY)
#define POS_MATZAHBALL  ccp(400 * SCALEX, 430 * SCALEY)
#define POS_MATZAH      ccp(400 * SCALEX, 430 * SCALEY)
...
void CharacterLayer::createObjects()
{
    ...
    switch (item) {
        ...
        case item_Fish:
            ...
            break;
        case item_Matzah:
            shootItem->setPosition(POS_MATZAH);
            break;
        case item_JewishStar:
            shootItem->setPosition(POS_STAR);
            break;
        case item_LightBulb:
            shootItem->setPosition(POS_BULB);
            break;
        case item_MatzahBall:
            shootItem->setPosition(POS_MATZAHBALL);
            break;
        default:
            break;
    }
