...
// Show Shoot Item
    ...
    switch (item_no) {
        ...
        case item_JewishStar:
            item_image = CCSprite::create(getResPath(STORE_TABLE_STAR_OFF));
            break;
        case item_LightBulb:
            item_image = CCSprite::create(getResPath(STORE_TABLE_BULB_OFF));
            break;
        case item_Matzah:
            item_image = CCSprite::create(getResPath(STORE_TABLE_MATZAH_OFF));
            break;
        case item_MatzahBall:
            item_image = CCSprite::create(getResPath(STORE_TABLE_MATZAHBALL_OFF));
            break;
        default:
            break;
    }
