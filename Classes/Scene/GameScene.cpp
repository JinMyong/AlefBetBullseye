...
void GameScene::doShoot(int aimedLetter, CCPoint dest)
{
    ...
    string selectedLetter = HebrewUtils::getInstance()->getLetterName(aimedLetter - TAG_TARGET);
    string rightLetter = HebrewUtils::getInstance()->getLetterName(lastTargetLetter);
