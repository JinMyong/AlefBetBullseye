...
bool GameOptions::isBoughtItem(ThrowThings value)
{
    ...
    switch (value) {
        ...
        case item_JewishStar:
            retValue = userDefault->getBoolForKey(KEY_BOUGHT_STAR, false);
            break;
        case item_LightBulb:
            retValue = userDefault->getBoolForKey(KEY_BOUGHT_BULB, false);
            break;
        case item_Matzah:
            retValue = userDefault->getBoolForKey(KEY_BOUGHT_MATZAH, false);
            break;
        case item_MatzahBall:
            retValue = userDefault->getBoolForKey(KEY_BOUGHT_MATZAHBALL, false);
            break;
        default:
            break;
    }
...
void GameOptions::setFontType(bool value)
{
    ...
    if (fontType) {
        HebrewUtils::getInstance()->setupLetterFontKeyMap_Print();
    }else
    {
        HebrewUtils::getInstance()->setupLetterFontKeyMap_Cursive();
    }
}
...
void GameOptions::setBuyItem(ThrowThings value)
{
    switch (value) {
        ...
        case item_JewishStar:
            ...
            userDefault->setBoolForKey(KEY_BOUGHT_STAR, true);
            break;
        case item_LightBulb:
        ...
        case item_Matzah:
            ...
            userDefault->setBoolForKey(KEY_BOUGHT_MATZAH, true);
            break;
        case item_MatzahBall:
            this->setCoins(coin_count - PRICE_MATZAHBALL);
            userDefault->setBoolForKey(KEY_BOUGHT_MATZAHBALL, true);
            break;
        default:
            break;
    }
